      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/40 dark:to-blue-800/40 rounded-2xl p-5 sm:p-6 shadow-lg border border-blue-200 dark:border-blue-700">
          <div className="flex items-start justify-between mb-2">
            <h3 className="text-xs sm:text-sm font-medium text-blue-800 dark:text-blue-300 uppercase tracking-wide mt-1">
              Total Cost
            </h3>
            <svg className="w-7 h-7 sm:w-8 sm:h-8 text-blue-600 dark:text-blue-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/40 dark:to-amber-800/40 rounded-2xl p-5 sm:p-6 shadow-lg border border-amber-200 dark:border-amber-700">
          <div className="flex items-start justify-between mb-2">
            <h3 className="text-xs sm:text-sm font-medium text-amber-800 dark:text-amber-300 uppercase tracking-wide mt-1">
              Upcoming Renewals
            </h3>
            <svg className="w-7 h-7 sm:w-8 sm:h-8 text-amber-600 dark:text-amber-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/40 dark:to-emerald-800/40 rounded-2xl p-5 sm:p-6 shadow-lg border border-emerald-200 dark:border-emerald-700 sm:col-span-2 lg:col-span-1">
          <div className="flex items-start justify-between mb-2">
            <h3 className="text-xs sm:text-sm font-medium text-emerald-800 dark:text-emerald-300 uppercase tracking-wide mt-1">
              Outstanding Loans
            </h3>
            <svg className="w-7 h-7 sm:w-8 sm:h-8 text-emerald-600 dark:text-emerald-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
